...
updatedv=$(curl  -s 'https://raw.githubusercontent.com/joshilita/NewOSv3-os/main/.vers/?$RANDOM' | sed -n '1p')
updateins=$(curl  -s 'https://raw.githubusercontent.com/joshilita/NewOSv3-os/main/.vers/?$RANDOM' | sed -n '3p')
clear
machine=$(uname -o)
